...
function useDragSort(props, context, params) {
  ...
  Vue.watch(function () {
    return _toConsumableArray__default["default"](columns.value);
  }, function (columns2) {
    ...
    var options = _objectSpread({
      ...
      onEnd: function onEnd(evt) {
        ...
        if (recover) {
          ...
          (_dragColInstanceTmp = dragColInstanceTmp) === null || _dragColInstanceTmp === void 0 || _dragColInstanceTmp.sort(_toConsumableArray__default["default"](lastColList.value));
        }
